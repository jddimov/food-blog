  ...
  return(
    <div className="slider-wrapper">
      ...
      <div className="slider-wrapper__buttons">
        <button onClick={showPrevSlide} disabled={activeSlide === 0} className='previous' >&lt;</button>
        <button onClick={showNextSlide} disabled={activeSlide === children.length - 1} className='next'>&gt;</button>
      </div>

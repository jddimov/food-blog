...
const CardInfo = [
    ...
    },
    {
        ...
        url: "pizza-dough",
        title: "Тесто за пица",
        products: "<u>Необходими продукти: </u> <br> <br>&nbsp&nbsp-1 кг брашно тип 00 <br>&nbsp&nbsp-2 гр. Суха мая <br>&nbsp&nbsp-30 гр сол <br>&nbsp&nbsp-30 гр зехтин<br>&nbsp&nbsp-600мл вода",
    ...
    },
    {
        ...
        products: "<u>Необходими продукти: </u> <br> <br> 120 гр шоколад <br> &nbsp&nbsp-70 гр какао<br> &nbsp&nbsp-90 гр масло <br> &nbsp&nbsp-200 гр захар <br> &nbsp&nbsp-3 яйца <br> &nbsp&nbsp-ванилия<br> &nbsp&nbsp-шипка сол<br> &nbsp&nbsp-½ пакетче бакпулвер<br> &nbsp&nbsp-100 гр Брашно <br> &nbsp&nbsp-1 чаша прясно кафе<br> &nbsp&nbsp-150 гр шоколад на парченца",
        description: "Това е един мой много любим десерт. Ако обичате мноого шоколад, то това е за вас. <br><br>Загрейте фурната на 180 градуса. <br>Разтопете на водна баня шоколада и маслото. В друга купа смесете яйцата и захарта и разбийте до пълното и разтваряне. Добавете брашното, какаото, солта, ванилията и кафето и отново разбъркайте. След като сместа от шоколад и масло се охлади, я добавете при брашното и разбъркайте. Изсипете парченцата шоколад и разбъркайте до като се поемат от сместа. <br>В тавичката, в която ще печете, сложете хартия за печене и изсипете сместа. Печете за около 30 минути, без да отваряте фурната. След като е готово браунито го изчакайте да изстине преди да го разрежете.",
        minutes: "50 мин",
        difficulty: "2",
        servings: "9",
        category: "dessert"
    },
    {
        ...
        products: "<u>Необходими продукти: </u> <br> <br>400 гр брашно<br> &nbsp&nbsp-2 яйца<br> &nbsp&nbsp-1 жълтък <br> &nbsp&nbsp-1 ч.л. кафе<br> &nbsp&nbsp-½ ч.л. канела<br> &nbsp&nbsp-щипка сол<br> &nbsp&nbsp-25 мл. Зехтин<br> &nbsp&nbsp-35 гр. разтопено масло<br> &nbsp&nbsp-2 ч.л. марсала (ако нямате, може да използвате и бял винен оцет)<br> &nbsp&nbsp-30 мл. Бяло вино<br> &nbsp&nbsp-1 белтък<br><br>Продукти за крема:<br> &nbsp&nbsp-400 гр рикота, която е предварително отцедена <br> &nbsp&nbsp-100 гр захар ( или на вкус) <br> &nbsp&nbsp-кората от ½ лимон, портокал и лайм<br><br>Ще ви трябват още и: <br> &nbsp&nbsp-форми за каноли или алуминиево фолио",
        description: "Същия вкус като в Италия. Наистина лесна за изпълнение рецепта. Съдържа стандартни продукти, които почти винаги се намират в къщата ви. <br><br>Пресейте брашното с канелата и солта. Към тях добавете останалите продукти и замесете твърдо тесто. Оставете го да си почине за около 30 минути в  хладилник. <br>Тук има два варианта, или да изпържите канолите в олио или да ги запечете във фурната. Пробвала съм и двата варианта и честно да ви кажа, няма чак толкова голяма разлика, за домашни условия. <br>Разточете тестото на тънко, изрежете кръгла форма и я завиите около формата за канола, като мажете с белтък края и, за да залепне. Ако пък нямате формичка, може да с направите от алуминиево фолио. Ако ще ги пържите, загрейте олио и ги пускайте в него. Ако пък ще ги печете, загрейте фурната и след като ги наредите в тавичка ги поръсете с малко олио. Пекат се до готовност за около 15 минути. <br>Вече изстиналите каноли се пълнят с шприц и се гарнират пожелание с шоколадови парченца, ядки или сушени плодове.",
        minutes: "90 мин",
        difficulty: "2",
        servings: "20",
        category: "dessert"
    },
    {
        ...
        products: "<u>Необходими продукти: </u> <br> <br>&nbsp&nbsp-650гр пилешко филе<br> &nbsp&nbsp-1 глава лук<br> &nbsp&nbsp-1 скилидка чесън<br> &nbsp&nbsp-1 яйце<br> &nbsp&nbsp-сол <br> &nbsp&nbsp-черен пипер<br> &nbsp&nbsp-червен пипер<br> &nbsp&nbsp-олио <br> &nbsp&nbsp-магданоз",
        description: "Когато ви е писнало от стандартното пилешко филе, това е едно разнообразие. Рецептата е много лесна. <br><br>Всичко се слага в кухненския робот и се смила много добре. Загрява се олио в тигана. Оформят се малки кюфтенца и се пържат до готовност.",
        minutes: "30 мин",
        difficulty: "1",
        servings: "4",
        category: "inspire"
    },
    {
        ...
        products: "<u>Необходими продукти: </u> <br> <br> &nbsp&nbsp-5 бр. свински котлети <br> &nbsp&nbsp-сол<br> &nbsp&nbsp-черен пипер<br> &nbsp&nbsp-кимион",
        description: "Най-важното в приготвянето на месо е неговото мариноване. Точно заради това, първо трябва да мариноваме месото с изброените продукти и след това да го оставим да си почине. <br><br>След около час загряваме скарата, мажем я хубаво със сланина или лук и изпичаме котлета от двете страни. Поднасяме със зелена салата и чаша хубаво червено вино.",
        minutes: "90 мин",
        difficulty: "1",
        servings: "5",
        category: "main-dish"
    },
    {
        ...
        products: "<u>Необходими продукти: </u> <br> <br>&nbsp&nbsp-500 гр суров спанак<br> &nbsp&nbsp-300 гр извара <br> &nbsp&nbsp-200 гр сирене<br> &nbsp&nbsp-2 скилдики чесън<br> &nbsp&nbsp-сол<br> &nbsp&nbsp-черен пипер<br> &nbsp&nbsp-червен пипер<br> &nbsp&nbsp-копър<br> &nbsp&nbsp-олио<br><br>За соса:<br> &nbsp&nbsp-кисело мляко<br> &nbsp&nbsp-майонеза<br> &nbsp&nbsp-чесън<br> &nbsp&nbsp-сол<br> &nbsp&nbsp-копър<br> &nbsp&nbsp-зехтин",
        description: "Една пролетна рецепта със спанак. <br><br> Първото нещо е да изчистим спанака. Махаме дръжките и го накисваме във вода, за да се махне пясъка, ако има такъв. <br> След това го слагаме в тиган с малко вода, за да го сготвим. Когато е готов смесваме всички продукти и оформяме кюфтенца. Печем в предварително загрята фурна на 200 гр за около 40 мин. <br>През това време приготвяме чесновия сос като смесваме всички продукти за него.",
        minutes: "80 мин",
        difficulty: "1",
        servings: "6",
        category: "inspire"
    },
    {
        ...
        url: "greek-salad",
        title: "Гръцка салата",
        products: "<u>Необходими продукти: </u> <br> <br> &nbsp&nbsp-краставица<br> &nbsp&nbsp-домат<br> &nbsp&nbsp-лук<br> &nbsp&nbsp-сурова чушка<br> &nbsp&nbsp-маслини<br> &nbsp&nbsp-сирене<br> &nbsp&nbsp-франзела/ крутони <br> &nbsp&nbsp-зехтин<br> &nbsp&nbsp-сол<br> &nbsp&nbsp-оцет (пожелание)<br> &nbsp&nbsp-риган",
        description: "Една много любима салата на моето семейство, лесна и свежа. <br><br> Разрязваме франзелата и я запичаме на тиган. Доматите и краставиците се режат на кубчета, лука и чушката на кръгчета. Слагаме в дълбока чиния всички продукти, поръсваме щедро със зехтин, сол, оцет и риган и разбъркваме. Слагаме отгоре вече запечената франзела и парче сирене. Отново поръсваме със зехтин и риган. Поднасяме или със студено гръцко узо или пък с българска ракия.",
        minutes: "10 мин",
        difficulty: "1",
        servings: "2",
        category: "salad"
    },
    {
        ...
        description: "Още една вариация на чийзкейк, която не е съдържа само крема сирене, а и сладкарска извара, която го прави неустоимо вкусен.  <br><br>Разтопете маслото или в микровълнова фурна, или на водна баня. Разбийте в блендер или на ръка бисквитите и след като станат на трохи добавете маслото при тях и разбъркайте. В тавата, която ще печете чийзкейка, изсипете бисквитите и притиснете хубаво, за да  залепнат на дъното. Докато приготвяте крема, оставете тавата в хладилника, за да може да стегне. <br>Загрейте фурната на 180 гр. без вентилатор. <br> За крема разбийте захарта и яйцата с миксер. След като захарта се разтопи, добавете крема сиренето и сладкарската извара и продължете да разбивате, а след това добавете и ванилията. <br> Извадете от хладилника вече стегналия блат и изсипете крема при него. Пече се за около 30-40 мин зависимост от вашата фурна. Готов е, когато краищата са стегнали, а в средата леко мърда. След като го извадите от фурната, изчакайте да изстине напълно и изсипете сладкото. Отново върнете в хладилника до пълното му стягане.",
        minutes: "70 мин",
        difficulty: "2",
        servings: "12",
        category: "dessert"
    },
    {
        ...
        url: "homemade-pasta",
        title: "Домашна паста",
        products: "<u>Необходими продукти: </u> <br> <br>&nbsp&nbsp-100 грама брашно за паста<br> &nbsp&nbsp-1 яйце<br> &nbsp&nbsp-малко вода<br> &nbsp&nbsp-2 гр сол",
        description: "Няма нищо по-вкусно от приготвена домашна прясна паста, вкус като в Италия. <br><br>Продуктите, които давам са за 1 порция. На всеки 100 гр. брашно се слага 1 яйце. В зависимост от големината му, може да потрябва и малко вода. Целта е тестото да бъде твърдо. <br>След като се замеси хубаво, се оставя поне за 30 минути да си почине. Задължително трябва да е завито с фолио за свежо съхранение, за да не изсъхва. Ако имате машина за паста – използвайте я, аз го правя на ръка. Разточваме тестото на тънко, като обилно поръсваме с брашно, за да не залепне, завиваме го на руло, без да притискаме и режем с остър нож желаната дебелина. Пастата може да я варите веднага или пък да я оставите да изсъхне за няколко часа, но не забравяйте да я поръсите с брашно.",
        minutes: "30 мин",
        difficulty: "2",
        servings: "1",
        category: "inspire"
    },
    {
        ...
        url: "backed-eggs",
        title: "Печени яйца",
        products: "<u>Необходими продукти: </u> <br> <br>&nbsp&nbsp-4 яйца<br> &nbsp&nbsp-200 гр домати <br> &nbsp&nbsp-100 гр. сирене <br> &nbsp&nbsp-масло <br> &nbsp&nbsp-сол<br> &nbsp&nbsp-черен пипер<br> &nbsp&nbsp-босилек, магданоз или копър<br> &nbsp&nbsp-хлебче",
        description: "Когато искате да разнообразите сутрешната закуска, това е един различен вариант на нещо като сирене по шопски, в който има много протеин. <br><br>Загрейте фурната на 200 градуса. В една тавичка нарежете доматите, маслото и сиренето. Сложете ги във фурната и ги запечете за около 15-20 минути. <br>След това, в тавичката при доматите счупете яйцата и ги върнете във фурната. Печете още около 10 минути. След като са готови поръсете със сол, черен пипер и зелена подправка за свежест. Сервирайте с препечено хлебче.",
        minutes: "30 мин",
        difficulty: "1",
        servings: "7",
        category: "inspire"

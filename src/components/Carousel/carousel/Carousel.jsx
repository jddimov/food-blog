...
const Carousel = ({ slides, interval = 5000, controls = false, indicators = false, autoPlay = true, width = 4000}) => {
    ...
    return (
        <div className="carousel" className='carousel' style={{ maxWidth : width }}>
            <div 
